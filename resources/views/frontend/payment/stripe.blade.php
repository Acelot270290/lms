...
<<script type="text/javascript">
    // Create a Stripe client using the key from config
    ...
    // Create an instance of the card Element, hide the postal code
    var card = elements.create('card', {
        style: style,
        hidePostalCode: true  // Esconde o campo do código postal
    });
