...
<header class="header-menu-area bg-white">
    ...
    <li class="d-flex align-items-center"><i class="la la-user mr-1"></i><a href="{{ route('register') }}"> Cadastro</a></li>
...
<div class="col-lg-10">
    <div class="menu-wrapper">
        <div class="menu-category">
            <ul>
                <li>
                    <a href="#">Categorias <i class="la la-angle-down fs-12"></i></a>
        ...
        <form method="post">
            <div class="form-group mb-0">
                <input class="form-control form--control pl-3" type="text" name="search" placeholder="Procure pelo curso">
        ...
        <nav class="main-menu">
            <ul>
                ...
                <li>
                    <a href="#">Cursos <i class="la la-angle-down fs-12"></i></a>
                    <ul class="dropdown-menu-item">
                        <li><a href="course-grid.html">cursos grid</a></li>
                        <li><a href="course-list.html">cursos lista</a></li>
