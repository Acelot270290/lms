    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Faça Login!</h3>
        ...
        <div class="btn-box">
            <div class="d-flex align-items-center justify-content-between pb-4">
                ...
                <a href="recover.html" class="btn-text">Perdeu a Senha??</a>
            </div>
            <button class="btn theme-btn" type="submit">Login <i class="la la-arrow-right icon ml-1"></i></button>
            <p class="fs-14 pt-2">Ainda sem uma conta? <a href="sign-up.html" class="text-color hover-underline">Register</a></p>
        </div><!-- end btn-box -->
    </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
