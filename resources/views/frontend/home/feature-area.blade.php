        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Professores Porifissionais</h3>
                    <p class="info__text">Professorres formados e que atuam na área de educação</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Comunidade de Músicos</h3>
                    <p class="info__text">Forum aonde os alunos se conectam</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Certificações</h3>
                    <p class="info__text">Geramos certificados de horas</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
